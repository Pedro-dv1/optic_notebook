...
function CenteredNotice({ error }: { error: unknown }) {
  return <div className="mx-auto max-w-xl px-5 py-20"><Notice>{apiErrorMessage(error)}</Notice><Link to="/cliente" className="btn btn-secondary mt-5">Voltar à busca</Link></div>
}
